...
#
# Created: Sun Feb 26 22:21:15 2012
...
class Ui_CDRipperOptionsPage(object):
    def setupUi(self, CDRipperOptionsPage):
        ...
        self.media_library_info.setTitle(QtGui.QApplication.translate("CDRipperOptionsPage", "Library options", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.library_path_label = QtGui.QLabel(self.media_library_info)
        self.library_path_label.setText(QtGui.QApplication.translate("CDRipperOptionsPage", "Base path for ripped media:", None, QtGui.QApplication.UnicodeUTF8))
        self.library_path_label.setObjectName(_fromUtf8("library_path_label"))
        self.vboxlayout1.addWidget(self.library_path_label)
        self.library_path = QtGui.QLineEdit(self.media_library_info)
        self.library_path.setObjectName(_fromUtf8("library_path"))
        self.vboxlayout1.addWidget(self.library_path)
