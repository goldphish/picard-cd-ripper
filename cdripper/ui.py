...
class Ui_CDRipperUI(object):
    def setupUi(self, CDRipperUI):
        ...
        self.accuraterip = QtWidgets.QWidget()
        self.accuraterip.setObjectName("accuraterip")
        self.ar_output = QtWidgets.QPlainTextEdit(self.accuraterip)
        self.ar_output.setGeometry(QtCore.QRect(0, 0, 981, 241))
        self.ar_output.setObjectName("ar_output")
        self.ripper_tab.addTab(self.accuraterip, "AccurateRip")
